...
import {
  useSavedTravelPlanQuery,
  useTravelPlanMutations,
} from '../../../hooks/useTravelPlanApi';
import { ApiError } from '../../../utils/apiClient';
import {
  travelPlanNodeFromSavedPayload,
  travelPlanNodeToPayload,
} from './travelPlanApiMapper';
...
import { computeTravelPlanDateRangeLabel } from './travelPlanDateTime';
import {
  applyActivityNodeOverrides,
  mergeTravelPlanNodes,
  normalizeHiddenActivityNodeIds,
  sortTravelPlanNodes,
} from './travelPlanMerge';
import {
...
export function useTravelPlanPage({
  ...
  const persistPlan = useCallback(
    ...
    [activityLegacyId, apiEnabled, resolvedEventMeta, save, savedQuery],
  );
