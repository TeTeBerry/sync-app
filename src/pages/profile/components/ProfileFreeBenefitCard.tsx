...
function QuotaFraction({
  ...
  return (
    <View className="s-profile-free-benefit__quota">
      ...
      <Text className="s-profile-free-benefit__quota-rest">
        {" "}
        / {limit} 次
      </Text>
    </View>
    ...
    <View className="s-profile-free-benefit__inner">
      <View className="s-profile-free-benefit__header">
        <View className="s-profile-free-benefit__header-left">
          <Ticket size={16} color="#c7c7cc" className="s-profile-free-benefit__ticket-icon" aria-hidden />
      ...
      <View className="s-profile-free-benefit__row">
        <View className="s-profile-free-benefit__row-top">
          <View className="s-profile-free-benefit__row-label-wrap">
            <Sparkles size={14} color="var(--primary)" className="s-profile-free-benefit__row-icon" aria-hidden />
      ...
      <View className="s-profile-free-benefit__row">
        <View className="s-profile-free-benefit__row-top">
          <View className="s-profile-free-benefit__row-label-wrap">
            <Lock size={14} color="#d4a017" className="s-profile-free-benefit__row-icon" aria-hidden />
      ...
      <View
        ...
        onClick={onOpenUpgrade}>
        <Crown size={14} color="var(--primary)" className="s-profile-free-benefit__footer-crown" aria-hidden />
