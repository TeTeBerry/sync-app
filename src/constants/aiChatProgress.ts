...
export const AI_CHAT_PROGRESS_STAGES: Record<AiChatProgressKind, readonly string[]> = {
  thinking: ['思考中…', '正在理解你的问题…'],
  lineup: ['正在查阵容…', '正在整理艺人名单…', '正在匹配曲风标签…'],
  activity: ['正在查活动…', '正在检索近期场次…'],
  travel_guide: [TRAVEL_GUIDE_GENERATING_TEXT, ...TRAVEL_GUIDE_GENERATING_STAGES],
