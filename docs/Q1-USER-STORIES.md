...
**Story**  
作为等待官宣的用户，当 `lineupPublished === false` 时，我想订阅阵容更新提醒，而不是看到空白错误。
...
> **Q2 收口**：冷启动人格裂变见 [Q2-USER-STORIES.md US-Q2-18](./Q2-USER-STORIES.md#us-q2-18--人格测试微信裂变--分享卡片-p2--m--)；现网分享链路已有，本 Story 侧重卡片视觉与合规终检。
