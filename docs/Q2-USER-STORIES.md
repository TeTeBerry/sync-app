...
| **D4** | 06-26 | W1 | Scene Agent 收口 · 招募墙动态 Chip | **Q2-31** · **Q2-32** · ~~Q2-37~~ · ~~Q2-38~~ ⏸ |
| **D5** | 06-27 | W1 | `rg` 合规终检 · 类目/协议材料 | ~~Q2-39~~ · ~~Q2-40~~ ⏸ · Q2-01 · — |
| D6～D7 | 06-28～29 | W1 | **缓冲**：P0 bug · 种子帖补量 · **Set 票选 + 人格裂变推流** · 联调回归 | Q2-21 · **Q2-53** · Q2-18 |
| D8～D10 | 06-30～07-02 | W2 | **US-Q2-52** 行程记账人均试算 · 遗留收口 · 运营配合 | **Q2-52** · Q2-21 |
...
**砍 scope 时（仍保 07-06 提审 · 只做 5 件）**

1. **US-Q2-21** 种子招募帖  
2. **US-Q2-53** Set 票选裂变（至少 Lite：投票 + 分享 + 招募墙 CTA）  
3. **US-Q2-27** Full ✅  
4. **US-Q2-06** 口径终检 + 冒烟  
5. **合规 grep** + 提审材料  
...
**Q2-31** scene-run · **Q2-50** Google Places Provider · **Q2-43** 必看 set · **Q2-44** 申请评论 AI · **Q2-47** 官宣规律 · 行为看板 · 偏好 A/B
