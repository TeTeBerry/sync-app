...
| US-Q2-37～40 | Raver 模式 / 室内 catalog / 本地 Hub / 室内详情 | 上海冷启动路径；不挡 festival 提审 |
...
| US-Q2-34 | 出征准备 Prep Nudge | P1 可选 | 🔲 |
| US-Q2-35 | 出行攻略预算对比选档 | P1 可选 | 🔲 |
| US-Q2-36 | 全球电音节资讯目录 | **P0 必做** | ✅ |
| US-Q2-37 | Raver 模式（本地 / 追节） | 上线后 P1 | 🔲 |
| US-Q2-38 | 室内活动 catalog 收录与多城 | 上线后 P1 | 🔲 |
| US-Q2-39 | 本地城市 Hub 聚合页 | 上线后 P1 | 🔲 |
| US-Q2-40 | 室内活动详情 · 艺人介绍 | 上线后 P1 | 🔲 |
...
- [ ] 预算偏好由 **US-Q2-35** 点选档位写入；城市等仍可在生成后 `applyTravelGuideHints`（MVP 暂用攻略表单 `budgetTier`）
...
- [ ] **查看艺人介绍** → DJ 半屏 / inline_card（复用 US-Q2-33 · `DjService.answerArtistProfile`）
...
**依赖**：US-Q2-38 · US-Q2-15 ✅ · （可选）US-Q2-33
...
US-Q2-31 · 32 · 33 · 23 · 24；**US-Q2-37** Raver 模式 · **US-Q2-38** 室内 catalog seed；视数据启动 US-Q2-17 / 27 完整版 · **US-Q2-19** 艺人串联

### Sprint 7（增长 · 有互动数据后）

US-Q2-17 · 18（卡片视觉 + 裂变埋点）· 29 · 28 · 30 · 19；**US-Q2-39** 本地 Hub · **US-Q2-40** 室内详情；US-Q2-20 下线清理  
**注**：US-Q2-18 分享基线现网已有；Sprint 7 收口测完→招募墙转化与分享卡片终检。

### Sprint 8（本地深化 · 上海验证后）

US-Q2-39 Hub 跨场 AI 找队 API · 深圳/香港 city seed · 翻卡跨场（US-Q2-29）· 艺人 Tab 串联（US-Q2-19）
