...
| 10 | **US-Q2-52** | **行程记账 · AI 人均分摊试算** | S | **W2** | 🔲 |
...
**Sprint 5（当前）**：**上线冲刺 ～2 周 · 3～4 大需求/天** — 种子帖 · 偏好 Lite · 攻略预填 · 日韩 Hot Path · **行程记账人均试算（Q2-52）** · 艺人/阵容增强 · 裂变闭环 · **07-06 提审不变**。
...
| **D2～D3** | 06-24～25 | W1 | **日韩攻略 Hot Path** Phase B + 冒烟 | **Q2-49** ✅ |
...
D5 本地轴（37～40）→ D4 Scene（31～32）→ D3 增长（28～29）→ D2 体验（23～24）→ D2 裂变（17～18）→ **最后砍** Phase B 日韩场（Q2-49 仅保 EDC Korea Phase A）
